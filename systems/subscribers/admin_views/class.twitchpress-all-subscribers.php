...
if ( ! class_exists( 'TwitchPress_ListTable_Subscribers' ) ) {
    require_once( 'class.twitchpress-listtable-subscribers.php' );
}                                        

/**
 * TwitchPress Data View for All Subscribers.   
 *
 * @author      Ryan Bayne
 * @category    Admin
 ...
 * @version     1.0.0
 */
class TwitchPress_DataView_All_Subscribers extends TwitchPress_ListTable_Subscribers {
