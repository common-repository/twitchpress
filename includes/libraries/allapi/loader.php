...
if( !get_option( 'twitchpress_discord' ) ) { 
    require( TWITCHPRESS_PLUGIN_DIR_PATH . 'includes/libraries/allapi/discord/class.api-discord.php' );
    require( TWITCHPRESS_PLUGIN_DIR_PATH . 'includes/libraries/allapi/discord/class.api-discord-listener.php' );
}
...
if( !get_option( 'twitchpress_streamlabs' ) ) {                                                         
    ...
    require( TWITCHPRESS_PLUGIN_DIR_PATH . 'includes/libraries/allapi/streamlabs/class.api-streamlabs.php' );
    require( TWITCHPRESS_PLUGIN_DIR_PATH . 'includes/libraries/allapi/streamlabs/class.api-streamlabs-listener.php' );
}
