...
function twitchpress_shortcode_channel_list( $atts ) {
    ...
    require_once( TWITCHPRESS_PLUGIN_DIR_PATH . '/pro/shortcodes/channellist/twitchpress-shortcode-channellist.php' );    
...
function twitchpress_shortcode_streamlabs( $atts ) { 
    if( TWITCHPRESS_PRO !== true ) { return 'prorequired'; }
    require_once( TWITCHPRESS_PLUGIN_DIR_PATH . '/pro/shortcodes/streamlabs/twitchpress-shortcode-streamlabs.php' );    
