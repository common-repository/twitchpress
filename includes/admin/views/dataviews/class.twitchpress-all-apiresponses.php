...
if ( ! class_exists( 'TwitchPress_ListTable_APIResponses' ) ) {
    require_once( 'class.twitchpress-listtable-apiresponses.php' );
}
 ...
 * @version     1.0
 */
class TwitchPress_DataView_All_APIResponses extends TwitchPress_ListTable_APIResponses {
