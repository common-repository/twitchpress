    ...
    public function get_settings( $current_section = '' ) {
        ...
        // Domain to Twitch API permission Options
            ...
            $settings = apply_filters( 'twitchpress_permissions_scope_settings', array(
                ...
                array(
                    'desc'            => __( 'moderation:read: View moderation data.', 'twitchpress' ),
                    'id'              => 'twitchpress_scope_moderation_read',
                    'default'         => $default,
                    'type'            => 'scopecheckbox',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
                ...
                array(
                    'desc'            => __( 'channel:read:subscriptions: Get your subscribers list.', 'twitchpress' ),
                    'id'              => 'twitchpress_scope_channel_read_subscriptions',
                    'default'         => $default,
                    'type'            => 'scopecheckbox',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
                ...
                array(
                    'desc'            => __( 'chat:edit: Allow this app to send chat messages.', 'twitchpress' ),
                    'id'              => 'twitchpress_scope_chat_edit',
                    'default'         => $default,
                    'type'            => 'scopecheckbox',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
                ...
                array(
                    'desc'            => __( 'chat:read: Allow this app to get chat messages.', 'twitchpress' ),
                    'id'              => 'twitchpress_scope_chat_read',
                    'default'         => $default,
                    'type'            => 'scopecheckbox',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
                ...
                array(
                    'desc'            => __( 'moderation:read: Get moderation data.', 'twitchpress' ),
                    'id'              => 'twitchpress_visitor_scope_moderation_read',
                    'default'         => $default,
                    'type'            => 'scopecheckboxpublic',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
                ...
                array(
                    'desc'            => __( 'channel:read:subscriptions: Get your subscribers list.', 'twitchpress' ),
                    'id'              => 'twitchpress_visitor_scope_channel_read_subscriptions',
                    'default'         => $default,
                    'type'            => 'scopecheckbox',
                    'checkboxgroup'   => '',
                    'show_if_checked' => 'yes',
