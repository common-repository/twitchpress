        ...
        switch ( $atts['defaultcontent'] ) {
           case 'videos':
                ...
                <div id="twitchpress-embed-everything">
                    <iframe
                        src="https://player.twitch.tv/?channel=' . $atts['channel'] . '&parent=' . embed_parent_string() . '&muted=true"
                        height="720"
                        width="1280"
           ...
           case 'video':
                ...
                <div id="twitchpress-embed-everything">
                    <iframe
                        src="https://player.twitch.tv/?video=' . $atts['videoid'] . '&parent=' . embed_parent_string() . '&autoplay=false"
                        height="720"
                        width="1280"
                        allowfullscreen="true">
                    </iframe>        
           ...
           case 'collection':
                ...
                <div id="twitchpress-embed-everything">
                    <iframe
                        src="https://player.twitch.tv/?collection=' . $atts['collectionid'] . '&parent=' . embed_parent_string() . '"
                        height="720"
                        width="1280"
                        allowfullscreen="true">
                    </iframe>        
    ...
    if( $result ) 
    {
        ...
        else
        {
            ...
            {                          
                ...
                $html_output .= '
                <iframe
                    src="https://player.twitch.tv/?video=' . $item->id . '&autoplay=false&parent=' . embed_parent_string() . '"
                    height="720"
                    width="1280"
                    frameborder="0"
                    scrolling="no"
